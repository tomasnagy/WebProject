...
function getLocation(o){navigator.geolocation?navigator.geolocation.getCurrentPosition(function(e){var n=new google.maps.Geocoder,t=new google.maps.LatLng(e.coords.latitude,e.coords.longitude);n.geocode({latLng:t},function(e,n){n==google.maps.GeocoderStatus.OK?(console.log(e),o(e[1]?e[1].address_components[0].long_name:"Space")):o("Space")})},function(){o("Space")}):(o("Space"),console.log("Geolocation is not supported by this browser."))}function codeLatLng(){}
