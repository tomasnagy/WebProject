...
function GuitarPlayerController(){"use strict";var e,o,t,r=io.connect(),a=[],n=function(e){e.user.name!==t.name&&(shakeRightGuitar(e.user.name),playChordFromSupportGuitar(e.user,e.chord,a))},i=document.getElementById("locationloader"),s=document.querySelector("#stage-container>figure"),u=document.getElementById("support-guitars");r.emit("requestkey"),r.on("getkey",function(c){e=c,console.log(e.name),getLocation(function(e){r.emit("join room",{key:c,location:e}),r.on("current room",function(e){o=e.room,t=e.user,TweenLite.to(i,.2,{className:"invisible"}),TweenLite.to([s,u],.2,{delay:.2,className:"-=invisible"}),loadGuitar(r,t,o.name),showBackgroundGuitars(o.users,t.name),a=loadSupportGuitarsSound(t.guitar),r.on("play chord",n),r.on("user count changed",function(e){showBackgroundGuitars(e,t.name)})})})}),window.addEventListener("beforeunload",function(){void 0!==o&&r.emit("leave room",{name:o.name,user:t})})}function loadGuitar(e,o,t){var r,a=new GuitarPlayerItem(o.guitar,!1),n=document.getElementById("chord1"),i=document.getElementById("chord2"),s=document.getElementById("chord3"),u=document.getElementById("chord4"),c=document.querySelector("#stage-container > figure > img"),m=function(){n.className="",i.className="",s.className="",u.className=""};c.src="/images/guitars/"+o.guitar+".svg",n.addEventListener("mouseenter",function(){a.playChord1(),m(),n.className="playing",clearTimeout(r),r=setTimeout(function(){m()},7e3),e.emit("send chord to server",{roomName:t,user:o,chord:1})}),i.addEventListener("mouseenter",function(){a.playChord2(),m(),i.className="playing",clearTimeout(r),r=setTimeout(function(){m()},7e3),e.emit("send chord to server",{roomName:t,user:o,chord:2})}),s.addEventListener("mouseenter",function(){a.playChord3(),m(),s.className="playing",clearTimeout(r),r=setTimeout(function(){m()},7e3),e.emit("send chord to server",{roomName:t,user:o,chord:3})}),u.addEventListener("mouseenter",function(){a.playChord4(),m(),u.className="playing",clearTimeout(r),r=setTimeout(function(){m()},7e3),e.emit("send chord to server",{roomName:t,user:o,chord:4})}),window.addEventListener("keydown",function(c){switch(c.keyCode){case 65:a.playChord1(),m(),n.className="playing",clearTimeout(r),r=setTimeout(function(){m()},7e3),e.emit("send chord to server",{roomName:t,user:o,chord:1});break;case 81:a.playChord1(),m(),n.className="playing",clearTimeout(r),r=setTimeout(function(){m()},7e3),e.emit("send chord to server",{roomName:t,user:o,chord:1});break;case 83:a.playChord2(),m(),i.className="playing",clearTimeout(r),r=setTimeout(function(){m()},7e3),e.emit("send chord to server",{roomName:t,user:o,chord:2});break;case 68:a.playChord3(),m(),s.className="playing",clearTimeout(r),r=setTimeout(function(){m()},7e3),e.emit("send chord to server",{roomName:t,user:o,chord:3});break;case 70:a.playChord4(),m(),u.className="playing",clearTimeout(r),r=setTimeout(function(){m()},7e3),e.emit("send chord to server",{roomName:t,user:o,chord:4})}})}function showBackgroundGuitars(e,o){var t,r=e.length-1,a="",n="",i=document.getElementById("support-guitars"),s=function(e){var o="";return e.length>17?(o=e.substring(0,17),o+="...",o.trim()):e.trim()};for(r;r>=0;r--)t=e[r],t.name!==o&&(n='<figure class="support-guitar" id="',n+=t.name,n+='"> <img src="/build/images/guitars/',n+=t.guitar,n+='.svg" alt="',n+=t.guitar,n+='" />',n+="<figcaption>",n+=s(t.location),n+="</figcaption></figure>",a+=n);i.innerHTML=a}function loadSupportGuitarsSound(e){var o,t,r=["cheap","heartBroken","practiceSpace","woollyOctave"],a=r.length-1,n=[];for(a;a>=0;a--)o=r[a],o!==e&&(t=new GuitarPlayerItem(o,!0),n.push(t));return n}function playChordFromSupportGuitar(e,o,t){var r,a=t.length-1;for(a;a>=0;a--)if(r=t[a],r.selectedGuitar===e.guitar)switch(o){case 1:r.playChord1();break;case 2:r.playChord2();break;case 3:r.playChord3();break;case 4:r.playChord4()}}function shakeRightGuitar(e){var o=document.getElementById(e),t=0,r=function(e){TweenMax.to(e,.05,{rotation:46}),TweenMax.to(e,.05,{rotation:44,delay:.05}),50>t?setTimeout(function(){r(e),t++},100):TweenMax.to(e,.1,{rotation:45,delay:.1})};r(o)}
