...
!function(){"use strict";var t=function(t,a,i){var o=!1;t.items=[],t.layoutDone=function(){i(function(){startAnimations(t.items),guitarPlayerController(o)},0)};var e=function(a){localStorage.setItem("guitarHistoryData",JSON.stringify(a)),angular.forEach(a.data,function(a){var i=new GuitarHistoryItem(a.title,a.date,a.description,a.image,a.interactiveGuitarName);t.items.push(i)})},r=function(){o=!0;var a=JSON.parse(localStorage.getItem("guitarHistoryData"));(void 0!==a||null!==a)&&angular.forEach(a.data,function(a){var i=new GuitarHistoryItem(a.title,a.date,a.description,a.image,a.interactiveGuitarName);t.items.push(i)})};a.get(window.location.protocol+"//"+window.location.host+"/api/allData").then(e,r)},a=angular.module("app");a.controller("HistoryItemController",["$scope","$http","$timeout",t])}();
