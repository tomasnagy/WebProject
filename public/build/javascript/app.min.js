...
function guitarPlayerController(e){"use strict";var t,n,o,r=[],a=function(e){e.user.name!==o.name&&(shakeRightGuitar(e.user.name),playChordFromSupportGuitar(e.user,e.chord,r))},i=document.getElementById("locationloader"),u=document.querySelector("#stage-container>figure"),c=document.getElementById("support-guitars");e?(TweenLite.to(i,.2,{className:"invisible"}),TweenLite.to([u,c],.2,{delay:.2,className:"-=invisible"}),loadGuitar(t,{name:"offlineUser",guitar:"cheap"},"offlineRoom")):(t=io.connect({"sync disconnect on unload":!0}),getLocation(function(e){t.emit("join room",e),t.on("current room",function(e){n=e.room,o=e.user,TweenLite.to(i,.2,{className:"invisible"}),TweenLite.to([u,c],.2,{delay:.2,className:"-=invisible"}),loadGuitar(t,o,n.name),showBackgroundGuitars(n.users,o.name),r=loadSupportGuitarsSound(o.guitar),t.on("play chord",a),t.on("user count changed",function(e){showBackgroundGuitars(e,o.name)})})}))}function loadGuitar(e,t,n){var o,r=new GuitarPlayerItem(t.guitar,!1),a=document.getElementById("chord1"),i=document.getElementById("chord2"),u=document.getElementById("chord3"),c=document.getElementById("chord4"),s=!1,d=document.querySelector("#stage-container > figure > img"),l=function(){a.className="",i.className="",u.className="",c.className=""},m=function(i){if(i){if(s)return;s=!0}r.playChord1(),l(),a.className="playing",clearTimeout(o),o=setTimeout(function(){l()},7e3),void 0!==e&&e.emit("send chord to server",{roomName:n,user:t,chord:1})},f=function(a){if(a){if(s)return;s=!0}r.playChord2(),l(),i.className="playing",clearTimeout(o),o=setTimeout(function(){l()},7e3),void 0!==e&&e.emit("send chord to server",{roomName:n,user:t,chord:2})},g=function(a){if(a){if(s)return;s=!0}r.playChord3(),l(),u.className="playing",clearTimeout(o),o=setTimeout(function(){l()},7e3),void 0!==e&&e.emit("send chord to server",{roomName:n,user:t,chord:3})},h=function(a){if(a){if(s)return;s=!0}r.playChord4(),l(),c.className="playing",clearTimeout(o),o=setTimeout(function(){l()},7e3),void 0!==e&&e.emit("send chord to server",{roomName:n,user:t,chord:4})};d.src="/build/images/guitars/"+t.guitar+".svg",a.addEventListener("mouseenter",function(){m(!1)}),i.addEventListener("mouseenter",function(){f(!1)}),u.addEventListener("mouseenter",function(){g(!1)}),c.addEventListener("mouseenter",function(){h(!1)}),a.addEventListener("click",function(){m(!1)}),i.addEventListener("click",function(){f(!1)}),u.addEventListener("click",function(){g(!1)}),c.addEventListener("click",function(){h(!1)}),window.addEventListener("keydown",function(e){switch(e.keyCode){case 65:m(!0);break;case 81:m(!0);break;case 83:f(!0);break;case 68:g(!0);break;case 70:h(!0)}}),window.addEventListener("keyup",function(){s=!1})}function showBackgroundGuitars(e,t){var n,o=e.length-1,r="",a="",i=document.getElementById("support-guitars"),u=function(e){var t="";return e.length>17?(t=e.substring(0,17),t+="...",t.trim()):e.trim()};for(o;o>=0;o--)n=e[o],n.name!==t&&(a='<figure class="support-guitar" id="',a+=n.name,a+='"> <img src="/build/images/guitars/',a+=n.guitar,a+='.svg" alt="',a+=n.guitar,a+='" />',a+="<figcaption>",a+=u(n.location),a+="</figcaption></figure>",r+=a);i.innerHTML=r}function loadSupportGuitarsSound(e){var t,n,o=["cheap","heartBroken","practiceSpace","woollyOctave"],r=o.length-1,a=[];for(r;r>=0;r--)t=o[r],t!==e&&(n=new GuitarPlayerItem(t,!0),a.push(n));return a}function playChordFromSupportGuitar(e,t,n){var o,r=n.length-1;for(r;r>=0;r--)if(o=n[r],o.selectedGuitar===e.guitar)switch(t){case 1:o.playChord1();break;case 2:o.playChord2();break;case 3:o.playChord3();break;case 4:o.playChord4()}}function shakeRightGuitar(e){var t=document.getElementById(e),n=0,o=function(e){TweenMax.to(e,.05,{rotation:46}),TweenMax.to(e,.05,{rotation:44,delay:.05}),50>n?setTimeout(function(){o(e),n++},100):TweenMax.to(e,.1,{rotation:45,delay:.1})};o(t)}
...
!function(){"use strict";var t=function(t,a,i){var e=!1;t.items=[],t.layoutDone=function(){i(function(){startAnimations(t.items),guitarPlayerController(e)},0)};var r=function(a){localStorage.setItem("guitarHistoryData",JSON.stringify(a)),angular.forEach(a.data,function(a){var i=new GuitarHistoryItem(a.title,a.date,a.description,a.image,a.interactiveGuitarName);t.items.push(i)})},o=function(){e=!0;var a=JSON.parse(localStorage.getItem("guitarHistoryData"));(void 0!==a||null!==a)&&angular.forEach(a.data,function(a){var i=new GuitarHistoryItem(a.title,a.date,a.description,a.image,a.interactiveGuitarName);t.items.push(i)})};a.get("http://"+window.location.host+"/api/allData").then(r,o)},a=angular.module("app");a.controller("HistoryItemController",["$scope","$http","$timeout",t])}();
